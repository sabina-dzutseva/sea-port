...
public class JsonGenerator {
    ...
    public static String result = "result.json";
    ...
    public static void jsonGenerate(ResultFormer resultFormer) {
        ...
        try {
            ...
            writer.writeValue(new FileOutputStream(result, true), resultFormer);
    ...
    public static ArrayList<Schedule> scheduleDeserialize(String file) {
        ...
        try {
            scheduleMappingIterator = reader.readValues(new File(file));
        } catch (IOException e) {
            e.printStackTrace();
        }
